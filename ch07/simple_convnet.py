...
class SimpleConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28), 
        ...
        self.params['W1'] = weight_init_std * \
                            np.random.randn(filter_num, input_dim[0], filter_size, filter_size)  # (30, 1, 5, 5)
        self.params['b1'] = np.zeros(filter_num)  # (30,)
        self.params['W2'] = weight_init_std * \
                            np.random.randn(pool_output_size, hidden_size)  # (4320, 100)
        ...
        self.layers['Conv1'] = Convolution(self.params['W1'], self.params['b1'],
                                           conv_param['stride'], conv_param['pad'])  # out (100, 30, 24, 24)
        self.layers['Relu1'] = Relu()  # out (100, 30, 24, 24)
        self.layers['Pool1'] = Pooling(pool_h=2, pool_w=2, stride=2)  # out (100, 30, 12, 12)
        self.layers['Affine1'] = Affine(self.params['W2'], self.params['b2'])  # out (100, 100)
        self.layers['Relu2'] = Relu()  # out (100, 100)
        self.layers['Affine2'] = Affine(self.params['W3'], self.params['b3'])  # out (100, 10)

        self.last_layer = SoftmaxWithLoss()  # out loss
